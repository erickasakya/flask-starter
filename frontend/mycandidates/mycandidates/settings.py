"""
Django settings for mycandidates project.
...
ROOT_URLCONF = 'mycandidates.urls'
...
WSGI_APPLICATION = 'mycandidates.wsgi.application'
...
CANDIDATES_BACKEND = os.environ['CANDIDATES_BACKEND_URL']
TOKENS_PUBLIC_KEY = '''
-----BEGIN PUBLIC KEY-----
